...
export default function Sobre(){
    return(
        ...
        <div className='WelcomeText'>
            ...
            <br />
            <p className='text1'>
               No Techkids, acreditamos que o aprendizado de tecnologia deve ser acessível,
               divertido e dinâmico tanto para as crianças, como para os professores. 
               Com nossa plataforma personalizada e interativa, buscamos abrir as portas para um mundo de conhecimento 
               sobre diversas areas de tecnologia.
            </p>
            <img src={Garota} alt='img3' id='menina' width='500px' />
        </div>

        <img src={missao} alt='img4' id='missao' width='300px' />
